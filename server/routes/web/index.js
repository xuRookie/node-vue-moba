...
module.exports = (app) => {
    ...
    // 手动初始化数据
    router.get('/news/init', async(req, res, next) => {
        try {
            const parent = await Category.findOne({name: '新闻分类'})
            const cats = await Category.find().where({
                parent: parent
            }).lean()
            const newsTitle = ["7月7日体验服停机更新公告", "7月7日体验服视频战报更新公告", "7月6日抢先服不停机优化公告", "7月3日体验服停机更新公告", "7月2日抢先服版本更新完成公告", "正式服预告⑤ | 体验大升级！背包轻松整理，开黑预约无阻", "【星元部件爆料】公孙离-觅星灵兔", "正式服预告④：荣耀战令爆料第二弹，暗夜都市，游侠将至！", "正式服预告③：荣耀战令新皮肤登场，“大镖客三兄弟”齐聚！", "王者峡谷云赛舟，今年端午特别“浪”"]
